...
const EditarDadosDeFaturamentoFinalizarPedido = () => {
    ...
    <>
      ...
      <Modal isCentered='false' isOpen={isOpen} onClose={onClose}>
        ...
        <MotionModalContent
          ...
          initial={mobileView ? { opacity: 0, y: 100, x: 0, scale: 0.1 } : { opacity: 0, y: 100, x: -300, scale: 0.1 }}
        ...
        >
          <ModalHeader color='#7fbc03'>Dados de <strong>Faturamento</strong></ModalHeader>
          ...
          <MotionModalModal
            ...
            animate={mobileView ? { y: 0, opacity: 1, transition: { delay: 0.2 } } : { y: 0, opacity: 1, transition: { delay: 0.5 } }}
          >
                  ...
                  render: () => (
                    <Box borderRadius='10px' borderLeft='5px solid green' color='white' p={2} bg='#7fbc03'>
                      <Flex justifyContent='space-between'>
                        <Text mt='5px'><strong>Dados de faturamento atualizados!</strong></Text>
...
export default EditarDadosDeFaturamentoFinalizarPedido
