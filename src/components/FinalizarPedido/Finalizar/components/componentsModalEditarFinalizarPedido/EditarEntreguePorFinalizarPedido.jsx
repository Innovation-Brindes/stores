...
export const EditarEntregueProFinazilarPedido = () => {
    ...
    <>
      ...
      <Modal isCentered='false' isOpen={isOpen} onClose={onClose}>
        ...
        <MotionModalContent
          ...
          initial={mobileView ? { opacity: 0, y: 100, x: 0, scale: 0.1 } : { opacity: 0, y: 100, x: 500, scale: 0.1 }}
        ...
        >
          <ModalHeader color='#7fbc03'>Dados da <strong>Entrega</strong></ModalHeader>
                  ...
                  render: () => (
                    <Box borderRadius='10px' borderLeft='5px solid green' color='white' p={2} bg='#7fbc03'>
                      <Flex justifyContent='space-between'>
                        <Text mt='5px'><strong>Dados da entrega atualizados!</strong></Text>
