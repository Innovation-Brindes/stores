    ...
    <Box bgColor="white">
      {!props.chat_only ? (
        <>
            ...
            <FooterContainerContentMobile>
              {!props.hiddenSlide && (
                <div className="md:hidden ">
                  <Divider>Mais de 50 mil clientes confiam na innovation</Divider>
                </div>
              )}
                  ...
                  <div id="carouselExampleDark2" class="carousel carousel-dark slide " data-bs-ride="carousel">
                    <div class="carousel-inner">
                      <div className="carousel-item active">
                        <div className="content-carousel-item d-block w-100" alt="First slide">
                          <Flex>
                            <img alt="parceiro1" src={parceiros1} />
                            <img alt="parceiro2" src={parceiros2} />
                          </Flex>
                        </div>
                      </div>
                      <div className="carousel-item">
                        <div className="content-carousel-item d-block w-100" alt="Second slide">
                          <Flex>
                            <img alt="parceiro3" src={parceiros3} />
                            <img alt="parceiro4" src={parceiros4} />
                          </Flex>
                        </div>
                      </div>
                      <div className="carousel-item">
                        <div className="content-carousel-item d-block w-100" alt="Third slide">
                          <Flex>
                            <img alt="parceiro5" src={parceiros5} />
                            <img alt="parceiro6" src={parceiros6} />
                          </Flex>
                        </div>
                      </div>
                      <div className="carousel-item">
                        <div className="content-carousel-item d-block w-100" alt="Fourth slide">
                          <Flex>
                            <img alt="parceiro7" src={parceiros7} />
                            <img alt="parceiro8" src={parceiros8} />
                          </Flex>
                        </div>
                      </div>
                      <div className="carousel-item">
                        <div className="content-carousel-item d-block w-100" alt="Fifth slide">
                          <Flex>
                            <img alt="parceiro9" src={parceiros9} />
                            <img alt="parceiro10" src={parceiros10} />
                          </Flex>
                        </div>
                      </div>
                      <div className="carousel-item">
                        <div className="content-carousel-item d-block w-100" alt="Sixth slide">
                          <Flex>
                            <img alt="parceiro11" src={parceiros11} />
                            <img alt="parceiro12" src={parceiros12} />
                          </Flex>
                        </div>
                      </div>
                    </div>
          ...
          <FooterContainer>
            {props.isUltraRapido ? (
              <Box bgColor="white" borderBottom="1px solid #d4d4d4" mx="auto" mb="40px" mt="-130px" w="90%" />
            ) : (
              <>
                  ...
                  <div id="carouselExampleDark3" class="carousel carousel-dark slide" data-bs-ride="carousel">
                    <div class="carousel-indicators">
                      <button
                        ...
                        data-bs-slide-to="0"
                        className="active button-carousel"
                        aria-current="true"
                        aria-label="Slide 1"
                        style={{
                          width: "17px",
                    ...
                    <div class="carousel-inner border-1 border-[#CFCFCF] w-10 rounded-2xl">
                      <div className="carousel-item active">
                        <img className="d-block w-100" src={parceiros1desk} alt="First slide" />
                      </div>
                      <div className="carousel-item">
                        <img className="d-block w-100" src={parceiros2desk} alt="Second slide" />
                      </div>
                      <div className="carousel-item">
                        <img className="d-block w-100" src={parceiros3desk} alt="Third slide" />
                      </div>
                    </div>
                  </div>
                </FooterContainerContantSlide3>
