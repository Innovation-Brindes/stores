...
const Card = ({
  ...
  const dadosInnovation = dataInfoClientes?.map((item, index) => {
    return (
      <S.Card
        width={isMinWidthMedium ? "100%" : "833px"}
        minHeight={"166px"}
        borderColor="#cecece"
        key={index}
      >
  ...
  const dataInfoTranspEntFat = dataInfoClientes?.map((item, index) => {
    return (
      <S.Card
        ...
        key={index}
      >
        <S.CardHeader bgColor="#7fbc03" textColor="white">
          {label}
        </S.CardHeader>
        <S.CardContent>
          <S.Wrapper>
              ...
              <>
                <Flex gap={".5rem"} flexDirection="column">
                  ...
                  <S.WrapperContent>
                    ...
                    <span>
                      {!isTransp && isFat
                        ? item.fat_insricao_estadual
                        : isEnt && item.ent_inscricao_estadual}{" "}
                    </span>
                  </S.WrapperContent>
                  <S.WrapperContent>
                    <span
                ...
                <Flex gap={".5rem"} flexDirection="column">
                  <Flex gap=".5rem" alignItems="center" justifyContent="start">
                    ...
                    <Text
                      as="span"
                      border={
                        item.destacar_data === "S" ? "1px solid #f21b1b" : ""
                      }
                  ...
                  <Flex gap=".8rem" marginTop="1rem">
                    <GoAlert size={20} color="#ff7e00 " />{" "}
                    <Text color="#ff7e00 ">Importante</Text>
                  </Flex>
                  <Text>
                    Não nos responsabilizamos por eventuais atrasos na entrega
                    de seus produtos por meio de transportadoras ou correios.
                  </Text>
                </Flex>
              </S.WrapperContent>
            )}
