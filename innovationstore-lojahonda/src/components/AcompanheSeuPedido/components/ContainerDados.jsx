...
import { Avatar, Box, Flex, Image, Text, VStack, Link, Icon } from "@chakra-ui/react"
import { FlexContato, FlexIcon, FlexContainerDados, ContainerFlexImages } from "../styles"
...
const ContainerDados = (props) => {
  ...
  return (
    <Flex maxW="1250px" m="auto" bgColor="white" mt="1.3rem">
      <VStack pt="30px" pl="40px" align="strench" fontFamily="Gisha" w={mobileView ? "90vw" : "60%"}>
        <Text textAlign={mobileView ? "center" : "strench"} pr="5px" fontSize={mobileView ? "18px" : "16px"}>
        ...
        <Flex fontSize="14px">
          ...
          <Text ml="15px">
            ...
            {props.state.dados_parceiro.estado} | {props.state.dados_parceiro.uf}
          </Text>
        </Flex>
      </VStack>
      ...
      <Flex w={mobileView ? "100vw" : "35%"}>
        ...
        <Flex flexDir="column" align="center" w={mobileView ? "60vw" : "65%"} pt="40px">
          <Link
          ...
          <Flex flexDir={"column"} align="center" justify="center">
            <Flex display={mobileView ? "none" : "block"}>
              <Link style={{ textDecoration: "none" }} href={`https://api.whatsapp.com/send?phone=551126496030&text=`}>
                <Icon color="#CC0000" as={AiFillPhone} position="relative" top="27px" h="25px" w="25px" />
                <Text ml="35px">
            ...
            <Flex display={mobileView ? "none" : "block"}>
              ...
              >
                <Icon color="#CC0000" as={GiSmartphone} position="relative" top="27px" h="25px" w="25px" />
                <Text ml="35px">
                  <strong>
            ...
            <Flex>
              ...
              >
                <Icon color="#CC0000" as={GrMail} position="relative" top="27px" h="25px" w="25px" />
                <Text ml="37px">
