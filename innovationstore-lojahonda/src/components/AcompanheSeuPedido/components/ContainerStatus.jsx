  ...
  return (
    <>
      {loading ? (
        ...
        <ContainerFlexStatusPedidoDesktop
          itens_pedido={props.state.itens_pedido}
          mx="auto"
        >
          {props.state.itens_pedido.length > 0 ? (
            ...
            >
              ...
              >
                Previsão de conclusão do seu pedido:{" "}
                <strong>
                  {props.state.dados_parceiro.data_previsao_pedido}
                </strong>
              </Text>
            </Flex>
          ) : (
              ...
              return (
                <>
                  <Flex>
                    <Text w="270px">
                      {item.nome_produto}{" "}
                      <strong>- {item.codigo_prod} -</strong>
                    </Text>
                    <Box
                      mt="13.5px"
                      mx="20px"
                  ...
                  >
                    {item.image_url ? (
                      <Link
                        href={`https://innovationbrindes.com.br/${item.link_produto}`}
                      >
                        <a target="_blank">
                          <Image
                            _hover={{
                    ...
                    <Flex flexDir="column" pt="20px" w="950px">
                      ...
                      >
                        ...
                        <Text
                          ml="15px"
                          color={
                            item.data_nota_fiscal_status === "S" &&
                            item.data_controle_status === "S"
                              ? "black"
                              : "#d1d1d1"
                          }
                      ...
                      <Flex h="50px">
                        <Progress
                          ...
                          size="sm"
                          isIndeterminate={
                            item.data_recebido_status === "S" ? true : false
                          }
                        ...
                        >
                          <Image
                            src={
                              item.data_recebido_status === "S"
                                ? "/images/check-acompanhe-seu-pedido.svg"
                                : "/images/check-acompanhe-seu-pedido-cinza.svg"
                            }
                            size="30px"
                          />
                        </Badge>
                        ...
                        <Progress
                          ...
                          size="sm"
                          isIndeterminate={
                            item.data_em_producao_status === "S" ? true : false
                          }
                          colorScheme="whiteAlpha"
                        ...
                        <Progress
                          ...
                          size="sm"
                          isIndeterminate={
                            item.data_controle_status === "S" ? true : false
                          }
                          colorScheme="whiteAlpha"
                        ...
                        <Progress
                          ...
                          size="sm"
                          isIndeterminate={
                            item.data_coletado_status === "S" ? true : false
                          }
                          colorScheme="whiteAlpha"
