...
export function PaymentMethods({ totalPedido }) {
  ...
  return (
    <Flex flexDir={"column"} paddingBlock={".8rem"} gap={2} borderBottom={"1px dashed #E2E2E2"} width={"100%"}>
      ...
      <Flex flexDir={"column"}>
        ...
        <Text pl={"2rem"} fontSize={".76rem"} fontWeight={"normal"} m={0} mb={".3rem"}>
      ...
      <Flex flexDir={"column"}>
        ...
        <Text pl={"2rem"} fontSize={".8rem"} fontWeight={"normal"} m={0} mb={".3rem"}>
          no boleto
        </Text>
        <Text pl={"2rem"} fontSize={"9px"} fontWeight={"normal"} m={0} color={"#919191"}>
