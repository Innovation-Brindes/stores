...
export function InfoValores() {
  ...
  const totalItensMais5Porcento = totalItens - totalItens * (percent / 100)
  ...
  return (
    <>
      ...
      <Flex justifyContent="space-between">
        ...
        <Text>
          {frete?.frete === 0 ? "Grátis" : isNaN(frete?.frete) ? "Selecione um frete" : formatPrice(frete?.frete)}
        </Text>
      </Flex>
